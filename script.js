...
    const journey = [
        // Etapa 1: Pergunta Visual de Engajamento
...
        
        // Etapa 5 a 10: Restante da Qualificação Visual
...
        
        // ALTERADO: Limpeza da UI antes de renderizar a nova etapa.
...
            ui.userInput.classList.remove('error');
            ...
            // REMOVIDO: A linha abaixo era a principal causa de travamento em celulares.
            // ui.userInput.focus(); 
...
            ui.messageContainer.appendChild(msgEl);
            ...
            // ADICIONADO: Cria um botão para o usuário avançar, essencial para mobile.
            const submitBtn = document.createElement('button');
            submitBtn.textContent = 'Avançar';
            submitBtn.className = 'option-btn submit-btn'; // Reutiliza estilo existente + adiciona classe específica.
            submitBtn.onclick = handleTextInput;
            ui.inputArea.appendChild(submitBtn);

        } else if (currentStep.type === 'multiple-choice') {
            ui.optionsContainer.style.display = 'flex'; // Garante que o container de opções esteja visível.
...
    };
    
    // MANTIDO: Este evento continua útil para usuários de desktop.
